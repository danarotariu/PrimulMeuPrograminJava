package com.itfactory.whileloop;
...
public class whileex4 {
        ...
        public static void main(String[] args)
        {
            ...
            {
                if(x == 5) {
                    //Acest break folosit in bucle ma ajuta ca la un momentdat sa inchid bucla. in acest caz,
                    // in momentul in care am generat 5, am iesti din bucla.
