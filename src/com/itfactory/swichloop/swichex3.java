package com.itfactory.swichloop;
...
public class swichex3 {
        ...
        public static void main(String[] args)
        {
            ...
            System.out.println("Banii de la mama sunt: " + x);
            System.out.println("Banii de la tata sunt: " + y);
            int sum = x + y;
            System.out.println("Banii de la parinti sunt: " + sum);
            switch (sum)
            {
                case 0:
                    ...
                    break;
                case 1:
                    System.out.println("Nu am primit nimic. Nu merg la film. Mai am nevoie de 4 lei.");
                    break;
                case 2:
                    System.out.println("Nu am primit nimic. Nu merg la film. Mai am nevoie de 3 lei.");
                    break;
                case 3:
                    System.out.println("Nu am primit nimic. Nu merg la film. Mai am nevoie de 2 lei.");
                    break;
                case 4:
                    System.out.println("Nu am primit nimic. Nu merg la film. Mai am nevoie de 1 lei.");
                    break;
                default:
